//Importing defaultUpgradeValues:
//This imports defaultUpgradeValues, which contains upgrade data for items (e.g., name, cost, increase) used in the game.
...
//createUpgrades() is called, which triggers the generation and display of upgrade HTML.
createUpgrades()

//Each object in upgrades represents an individual upgrade with several properties:
...
//This array lists milestones at which power-ups may become available or have an effect. 
//It can be used to unlock new power-ups at these specific intervals, giving players periodic boosts as they progress.
